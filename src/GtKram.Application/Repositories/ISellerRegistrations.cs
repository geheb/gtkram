...
public interface ISellerRegistrations
{
    ...
    Task<bool> Confirm(Guid eventId, Guid registrationId, bool confirmed, CancellationToken cancellationToken);
    ...
    Task<bool> NotifyRegistration(Guid registrationId, CancellationToken cancellationToken);
}
