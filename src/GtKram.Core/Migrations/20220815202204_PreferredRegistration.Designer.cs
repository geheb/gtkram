...
namespace GtKram.Core.Migrations
{
    ...
    [Migration("20220815202204_PreferredRegistration")]
    partial class PreferredRegistration
    {
...
#pragma warning disable 612, 618
            ...
            MySqlModelBuilderExtensions.HasCharSet(modelBuilder, "utf8mb4", DelegationModes.Default);

            modelBuilder.Entity("GtKram.Core.Entities.AccountNotification", b =>
                {
                    b.Property<byte[]>("Id")
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityRoleGuid", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityRoleClaimGuid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserGuid", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserClaimGuid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserLoginGuid", b =>
                {
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserRoleGuid", b =>
                {
                    b.Property<byte[]>("UserId")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserTokenGuid", b =>
                {
                    b.Property<byte[]>("UserId")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarBilling", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarBillingArticle", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarEvent", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarSeller", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarSellerArticle", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarSellerRegistration", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKram.Core.Entities.AccountNotification", b =>
                {
                    b.HasOne("GtKram.Core.Entities.IdentityUserGuid", "User")
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityRoleClaimGuid", b =>
                {
                    b.HasOne("GtKram.Core.Entities.IdentityRoleGuid", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserClaimGuid", b =>
                {
                    b.HasOne("GtKram.Core.Entities.IdentityUserGuid", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GtKram.Core.Entities.IdentityUserRoleGuid", b =>
                {
                    b.HasOne("GtKram.Core.Entities.IdentityRoleGuid", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarBilling", b =>
                {
                    b.HasOne("GtKram.Core.Entities.BazaarEvent", "BazaarEvent")
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarBillingArticle", b =>
                {
                    b.HasOne("GtKram.Core.Entities.BazaarBilling", "BazaarBilling")
                        .WithMany("BazaarBillingArticles")
                        .HasForeignKey("BazaarBillingId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("GtKram.Core.Entities.BazaarSellerArticle", "BazaarSellerArticle")
                        .WithOne("BazaarBillingArticle")
                        .HasForeignKey("GtKram.Core.Entities.BazaarBillingArticle", "BazaarSellerArticleId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarSellerArticle", b =>
                {
                    b.HasOne("GtKram.Core.Entities.BazaarSeller", "BazaarSeller")
            ...
            modelBuilder.Entity("GtKram.Core.Entities.BazaarSellerRegistration", b =>
                {
                    ...
                    b.HasOne("GtKram.Core.Entities.BazaarSeller", "BazaarSeller")
                        ...
                        .HasForeignKey("GtKram.Core.Entities.BazaarSellerRegistration", "BazaarSellerId")
                        .OnDelete(DeleteBehavior.NoAction);
